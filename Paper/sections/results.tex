...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{irf_baseline.pdf}
...
\input{tables/lp_main}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{irf_interaction.pdf}
...
standard error reaches about $1.9$, and is insignificant at every other horizon;
no estimate in the table reaches the conventional five percent threshold. The
...
sign, so the exercise mainly demonstrates how little a common euro area shock
combined with eleven national mortgage systems can identify.
...
consistent with any standard transmission mechanism and is the signature of
central bank information effects contaminating the surprise. Second, splitting
