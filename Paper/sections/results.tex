...
specification at the same three horizons. The interaction is
%TODO_TIMEFE: describe sign, size and significance after running
%02_merge_and_regress.R, then delete this marker.
consistent with the conclusions from Table \ref{tab:main}.
