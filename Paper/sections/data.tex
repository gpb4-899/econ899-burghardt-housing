...
full life of the euro so far, from the early convergence years and the
housing boom before 2008 through the financial and sovereign debt crises
and a decade of very low rates to the sharp tightening and subsequent
easing of 2022 to 2025. Its building blocks are house prices, the monetary
policy shock, the macroeconomic controls, and the measure of mortgage
market structure.
Table \ref{tab:summary} reports summary statistics for the estimation
sample.

{\footnotesize\input{tables/Table01_summary_stats}}

\subsection{House prices}

House prices come from the OECD Analytical House Prices dataset
\citep{oecd2026}, which I access through DBnomics. Each country reports a quarterly real residential
property price index with base year 2015. Index levels are not comparable
across countries, so the analysis works with cumulative log changes
...
comes from the Euro Area Monetary Policy event study Database
\citep[EA-MPD,][]{ecb2026} of \citet{altavilla2019}, which records how
asset prices move in a narrow
...
surprise component of the announcement, an identification strategy that
goes back to \citet{kuttner2001} and \citet{gurkaynak2005}. Compared with the one month rate,
...
contaminated. Ignoring this contamination is known to produce puzzling
estimates of monetary policy effects
\citep{nakamura2018, mirandaagrippino2021}. Following the sign restriction
of \citet{jarocinski2020}, I
...
Three Eurostat series \citep{eurostat2026} capture the domestic
macroeconomic environment. Real
...
because the monthly release reaches back to the late 1990s and covers the
whole sample, whereas the quarterly release starts only around 2009 for
most countries. Every control enters with a one quarter lag, so it is
...
form the second. A binary split like this is transparent but coarse, since
