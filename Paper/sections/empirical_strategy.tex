...
include time fixed effects, because the shock is common to all countries
and time effects would absorb it completely. This is a real cost of the design, and I
return to it below.
...
would add several parameters to a specification that is already asking a
lot from eleven countries. I therefore keep the interaction to the
