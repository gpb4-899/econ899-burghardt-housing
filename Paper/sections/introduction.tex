...
felt the tightening in their monthly payment within months. A German or
...
the same ECB decision could move national housing markets by very
different amounts.
...
tightening rests on indirect evidence, and neither the ECB nor the
national authorities that oversee housing finance can judge how unevenly a
common decision lands on national housing markets.
...
mismeasured, but the cleaned series lines up with the major ECB episodes
visible in Figure \ref{fig:shock}, and the contrast between raw and cleaned
surprises matches what the information effect literature predicts
(Table \ref{tab:rawpure}). The binary mortgage
