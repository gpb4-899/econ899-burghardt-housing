...
The main limitation is statistical power, and that limitation deserves a
concrete description. The design identifies the differential response from a single
...
section, so the within quarter comparison of Section \ref{sec:timefe},
which eleven countries can only estimate coarsely, could be run with real
statistical power, and \citet{battistini2025} show that such data exist
for the euro area. Household level data on
