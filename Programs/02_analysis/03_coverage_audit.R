# 03_coverage_audit.R
# Documents sample coverage of the lagged controls, overall and by
# country and year.
# Writes: Results/tables/coverage_audit.csv
...
# The baseline uses only GDP growth and inflation; unemployment enters
# a robustness table, so report both sample definitions.
